...
async def on_message(message):
    ...
    for embed in embeds:
        for field in embed.fields:
            if "AN EPIC TREE" in field.title:
                time.sleep(1)
...
async def on_message(message):
    ...
    for embed in embeds:
        for field in embed.fields:
            if "A LOOTBOX SUMMONING" in field.title:
                time.sleep(1)
...
async def on_message(message):
    ...
    for embed in embeds:
        for field in embed.fields:
            if "IT'S RAINING COINS" in field.title:
                time.sleep(1)
...
async def on_message(message):
    ...
    for embed in embeds:
        for field in embed.fields:
            if "A LEGENDARY BOSS" in field.title:
                time.sleep(1)
